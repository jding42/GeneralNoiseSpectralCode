...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 21 15:17:33 2020
...
def exp1():
    ...
    for parameter in parameters:
        correlation1,correlation2,correlation3=exp1single(iterations,prior,size,lamda/np.sqrt(size),noise,parameter)
...
def exp1single(iterations,prior,size,lamda,noise,parameter):
    ...
    return correlation1,correlation2,correlation3
