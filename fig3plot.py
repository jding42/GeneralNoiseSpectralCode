...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul  5 07:40:48 2020
...
def fig3plot(lamda, parameters, correlations1,correlations2,correlations3,correlations4):
    ...
    plt.savefig('NonIdenticalExperiment200lamda15.eps')
    plt.close()