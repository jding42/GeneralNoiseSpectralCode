...
def exp3():
    ...
    for parameter in parameters:
        correlation1,correlation2,correlation3,correlation4=exp3single(iterations,prior,size,lamda/np.sqrt(size),noise,parameter)
...
def exp3single(iterations,prior,size,lamda,noise,parameter):
    correlation1=[];
    correlation2=[];
    correlation3=[];
    correlation4=[];
